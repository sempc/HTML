...
<head>
	...
	<!-- JS -->
	<script src="/MemberPj/js/jquery-3.5.1.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/MemberPj/js/com/dditUtils.js?v=1"></script>
	<script type="text/javascript" src="/MemberPj/js/member/memberNew.js?v=1"></script>
...
<!--     <script type="text/javascript" src="../../js/comm/ui.js"></script> -->
	...
	<link rel="stylesheet" href="/MemberPj/js/lib/jquery-ui.css">
<!--   <link rel="stylesheet" href="/resources/demos/style.css"> -->
<!--   <script src="https://code.jquery.com/jquery-1.12.4.js"></script> -->
	<script src="/MemberPj/js/lib/jquery-ui.js"></script>
	<script src="/MemberPj/js/lib/datepicker-ko.js"></script>
...
/* 	.form-control:required {background:#fff url(../../images/bg-required.png) no-repeat left 7px center} */
	...
	.form-control.singleDate {min-width:125px;padding-right:25px;background:#fff url(/MemberPj/images/ico-date.png) no-repeat right 7px center}
/* 	.form-control.singleDate:required {background:#fff url(../../images/bg-required.png) no-repeat left 7px center, url(../../images/ico-date.png) no-repeat right 5px center} */
	...
	.form-group label.required {background: url(/MemberPj/images/bg-required.png) no-repeat right 5px center}
		...
		<form class="form-horizontal" id="fm">
			<div class="form-group">
				...
				<div class="col-sm-10 form-inline">
					...
					<span id="spMemId" style="display: none;">영어 소문자와 숫자 사용 가능. 3~15자리</span>
